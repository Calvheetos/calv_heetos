...
export const projectsData: Project[] = [
  ...
  {
    title: "PORTO SUMMER SCHOOL",
    projectType: ["SUMMER_SCHOOL"],
    date: "JUL 14-26 | 2024",
    collaborators: [""],
    tags: ["PORTO SUMMER SCHOOL", "2024"],
    notes: "'24",
    id: "000 000 001 407 24",
    banner: "projects/15_SUMMER_SCHOOL/capa_15.png",
    priority: 90,
    images: [
      "projects/15_SUMMER_SCHOOL/w_02.png",
      "projects/15_SUMMER_SCHOOL/w_03.png",
      "projects/15_SUMMER_SCHOOL/w_04.png",
      "projects/15_SUMMER_SCHOOL/w_05.png",
      "projects/15_SUMMER_SCHOOL/w_06.png",
      "projects/15_SUMMER_SCHOOL/w_07.png",
      "projects/15_SUMMER_SCHOOL/w_08.png",
      "projects/15_SUMMER_SCHOOL/IMG_001.png",
      "projects/15_SUMMER_SCHOOL/IMG_002.png",
      "projects/15_SUMMER_SCHOOL/IMG_003.png",
      "projects/15_SUMMER_SCHOOL/IMG_004.png",
      "projects/15_SUMMER_SCHOOL/IMG_005.png",
      "projects/15_SUMMER_SCHOOL/IMG_006.png",
      "projects/15_SUMMER_SCHOOL/IMG_007.png",
    ],
    links: { website: "https://portodesignsummerschool.com" },
    style: "w-full aspect-square object-cover object-center",
    info_pt: "Em 2024, participei na Porto Design Summer School, uma experiência muito enriquecedora a nível criativo e pessoal. Ao longo do programa, tive a oportunidade de trabalhar num ambiente colaborativo, experimentar novas abordagens ao design e desenvolver projetos com o acompanhamento dos tutores convidados dessa edição - Hamish Muir; André Cruz; Ana Resende; Andrew Howard - o que tornou todo o processo ainda mais estimulante e desafiante. Foi uma experiência que me ajudou a sair da rotina, a ganhar novas perspetivas e a reforçar a forma como olho para o design: não só como uma solução visual, mas como uma ferramenta de comunicação, reflexão e criação de significado.",
    info_en: "In 2024, I took part in the Porto Design Summer School, a highly enriching experience both creatively and personally. Throughout the programme, I had the opportunity to work in a collaborative environment, explore new approaches to design, and develop projects under the guidance of that year’s invited tutors — Hamish Muir, André Cruz, Ana Resende, and Andrew Howard — which made the whole process even more stimulating and challenging. It was an experience that helped me step outside my routine, gain new perspectives, and strengthen the way I approach design: not just as a visual solution, but as a tool for communication, reflection, and meaning-making.",
  },
  {
    title: "TEXTS, ONE BOOK",
    projectType: ["BOOK"],
    date: "MAY 14 | 2024 | ESAD.MAT",
    collaborators: ["@joanaa_0015", "@mila_silenina"],
    tags: ["ESAD.MAT", "2024"],
    notes: "'24",
    id: "000 000 001 405 24",
    banner: "projects/16_TEXTS, ONE BOOK/Frame 5.png",
    priority: 1,
    images: [
      "projects/16_TEXTS, ONE BOOK/Frame 1.png",
      "projects/16_TEXTS, ONE BOOK/Frame 3.png",
      "projects/16_TEXTS, ONE BOOK/Frame_4.png",
      "projects/16_TEXTS, ONE BOOK/WhatsApp Video 2025-07-24 at 12.43.27.mp4",
    ],
    links: { website: "https://www.instagram.com/reel/C1AEWwNiV60/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" },
    style: "w-full object-cover object-center",
    info_pt: "Projeto desenvolvido por @joanaa_0015, @calv_heetos e @mila_silenina, no âmbito do Mestrado em Design de Comunicação da ESAD de Matosinhos, com acompanhamento do @studio_andrew_howard e em contexto académico da @esadmatosinhos. “How to use 6 typographic voices in one song” foi um exercício de exploração editorial e tipográfica, centrado na relação entre ritmo, voz e composição visual.",
    info_en: "Project developed by @joanaa_0015, @calv_heetos and @mila_silenina as part of the Master’s in Communication Design at ESAD Matosinhos, with guidance from @studio_andrew_howard and within the academic context of @esadmatosinhos. “How to use 6 typographic voices in one song” was an editorial and typographic exploration focused on the relationship between rhythm, voice, and visual composition.",
  },
  {
    title: "PALAMENTA",
    projectType: ["BRAND"],
    date: "APRIL 27 | 2026 | FREEL",
    collaborators: [""],
    tags: ["2026"],
    notes: "'26",
    id: "000 000 002 704 26",
    banner: "projects/17_PALAMENTA/Frame 9.png",
    priority: 1,
    images: [
      "projects/17_PALAMENTA/Frame 2.png",
      "projects/17_PALAMENTA/Instagram post - 1.png",
      "projects/17_PALAMENTA/Frame 3.png",
      "projects/17_PALAMENTA/Instagram post - 12.png",
      "projects/17_PALAMENTA/Instagram post - 16.png",
    ],
    style: "w-full object-cover object-center",
    info_pt: "A PALAMENTA foi um projeto desenvolvido em contexto de freelancer, onde tive a responsabilidade de criar a identidade visual da marca e toda a produção de conteúdo para redes sociais. A marca nasce do conceito criado pelo Duarte Pinto, pescador que transformou a sua ligação ao mar e à natureza numa experiência gastronómica única. A proposta é simples, organizar almoços e jantares para grupos, famílias e amigos, baseados no que é pescado e colhido no próprio dia, como peixe fresco e cogumelos, valorizando a sazonalidade e a autenticidade dos ingredientes. O desenvolvimento da identidade procurou refletir essa relação direta com o território, evitando excessos e mantendo uma linguagem visual orgânica. No logótipo e no conteúdo criado para redes sociais, o foco esteve em transmitir proximidade, naturalidade e a experiência real à volta da mesa. Mais do que uma marca de gastronomia, a PALAMENTA posiciona-se como uma experiência de partilha, onde cada refeição é diferente e nasce do momento, do lugar e do que a natureza oferece.",
    info_en: "PALAMENTA was a freelance project in which I was responsible for developing the brand’s visual identity as well as producing all social media content. The brand is based on a concept created by Duarte Pinto, a fisherman who transformed his connection to the sea and nature into a unique gastronomic experience. The idea is simple: to host lunches and dinners for groups, families, and friends based on what is caught and foraged on the same day, such as fresh fish and wild mushrooms, valuing seasonality and the authenticity of the ingredients. The identity development aimed to reflect this direct relationship with the territory, avoiding excess and maintaining an organic visual language. In both the logo and the social media content created, the focus was on conveying closeness, naturalness, and the real experience around the table. More than a gastronomy brand, PALAMENTA positions itself as a shared experience, where each meal is different and emerges from the moment, the place, and what nature provides.",
  },
];
